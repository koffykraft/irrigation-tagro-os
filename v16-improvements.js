...
function boot(){if(typeof map==='undefined'||!window.TAGRO_CAD)return setTimeout(boot,80);
 ...
 const menu=document.createElement('div');menu.className='tagro-tools-menu';menu.innerHTML=`<div class="split"><button data-act="undo" title="Undo">↶</button><button data-act="redo" title="Redo">↷</button></div><button data-act="draw">Sketch / Draw</button><button data-act="cad">CAD</button><button data-act="measure">Measure</button><a href="design.html">Design page</a><a href="materials.html">Material list</a><a href="reference.html">Info / Reference</a><small>Compact tools; map remains the workspace.</small>`;wrap.appendChild(menu);
